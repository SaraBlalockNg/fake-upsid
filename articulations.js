...
const dipthong = new Set(['3i','@i','@u','@uu','EO~','Ei','Eo','Euu','Ie','Oi','Oih','Oi~','Oy','Ui','a+i','a+i~','aE','a_O~','aai','aau+','ae','ae9','ae9~','ai',
...
const approximant = new Set(['"hl','"hrA','"l','"l*','"l-','"l9','"lJ','"lh','"rA','BA','BA-','BA:','BAJ','L','PA','RA','RAW','RAW*','dlD','gA','gA*','hj','hl','hl-',
                    'hl.','hlD','hlJ','hw','j','j*','j_','j~','l','l*','l-','l.','l9','lD','lD-','lD:','lDJ','lJ','l_','l_h','lj','l~','r.A','rA','vA',
                    'w','w*','wj','w~']);

const nasal = new Set(['"hn','"n','"n*','"n:','"nJ','"nW','"nh','N','N*','N9','NJ','NW','Nh','Nm','hN','hNJ','hNW','hNm','hm','hn','hn-','hn.','hnD','hnJ',
                    'hn_','hnj','m','m*','m:','mD','mJ','mW','mW-','mh','n','n*','n-','n.','n:','nD','nD*','nDJ','nDh','nJ','nU','n_','n_h','nj','nj*',
                    'nj:','njW']);

const tapflap = new Set(['"l[','"r[','"r[J','hr[-','hr[J','l.[','l.[*','l[','l[J','r.[','r.[~','rDT','rDT*','rD[','rT','r[','r[*','r[-','r[F','r[J','r_[','v[']);

const trill = new Set(['"hr','"r','"r*','"r-','"r9','"rF','"rJ','R','d.r','hr','nr','r','r.','rD','rDJ','rJ','rj','t.r']);


const ejectivestop = new Set(['"t\'','b\'','c\'','d\'',"g'","k'","kJ'","kW'",'p\'','q\'','q9\'','qW\'','qW9\'','t\'','tD\'']);

const ejectivefricative = new Set(['"s\'',"C,'","P'","S'","X'","XW'","f'","hlDFJ'","s'","s.'","sD'","x'","xW'"]);

const ejectiveaffricate = new Set(['"tlF\'',"\"tlF':","\"tlFW'","\"ts'","\"ts':","\"tsW'","cC,\'","dZ'","dz'","klF'","kx':","pf'","qX'","qX':","qX9'","qX9':","qXW'",
                    "qXW9'","t.s'","tD0'","tDs'","tS'","tS':","tSW'","tlF'","ts'"]);

const implosive = new Set(["\"d<","b<","bJ<","d.<","d<","dD<","d_<","dj<","g<","p<","q<","t<",]);
const plosive = new Set(['"d','"d*','"d9','"dJ','"dW','"dh','"nd','"ndJ','"ndW','"nt','"t','"t*','"t-h','"t9','"t:','"tJ','"tJh','"tW','"tWh','"th','"thh','99','?','?9',
...
const affricate = new Set(['"dlF','"dz','"dzJ','"dzh','"nts','"tlF','"tlF*','"tlF:','"tlFWh','"tlFh','"ts','"ts*','"ts:','"tsJ','"tsW:','"tsWh','"tsh','"tshh','bv','cC','cC,','cC,h','cCW','cCh',
...
const fricative = new Set(['"6','"hlF','"hlF:','"hlFJ','"hlFW','"hlFW:','"hs','"lF','"ns','"nz','"rF','"s','"s9','"s:','"sJ','"sW','"sW:','"sh','"z','"z9','"zJ','"zW','0','0D',
...
const sonorant = flatUnion(vowel, dipthong, nasal, approximant, trill, tapflap);
const obstruent = flatUnion(ejectivestop, ejectiveaffricate, ejectivefricative, implosive, plosive, affricate, fricative);
const all_features = flatUnion(sonorant, obstruent);

export const features = {};
features['-any length-'] = flatUnion(sonorant, obstruent);
features['-any modifier-'] = flatUnion(sonorant, obstruent);
features['-any voicing-'] = flatUnion(sonorant, obstruent);
features['-any height-'] = flatUnion(sonorant, obstruent);
features['-any backness-'] = flatUnion(sonorant, obstruent);
features['-any rounding-'] = flatUnion(sonorant, obstruent);
features['-any vowel-'] = flatUnion(vowel, dipthong);
features['-any aspiration, etc.-'] = flatUnion(sonorant, obstruent);
features['-any sec. articulation-'] = flatUnion(sonorant, obstruent);
features['-any place-'] = flatUnion(sonorant, obstruent);
features['-any manner-'] = flatUnion(sonorant, obstruent);
features['-any release-'] = flatUnion(sonorant, obstruent);



features['overshort'] = new Set(['"@)S','"@S','"eS','"oS','4)S','4S','ES','IS','OS','US',
                        'UUS','aS','a_)S','iS','i_S','o/S','oS','u+S','uS']);
features['short'] = new Set([ //vowels
                        '"@','"@)','"@.','"@~','"e','"e*','"e9','"e_','"e~','"e~*','"he','"ho','"o','"o(','"o(+~','"o(~','"o*','"o+','"o/','"o/9','"o9','"o9~',
...
features['long'] = new Set(['"@:','"e:','"o(:','"o/:','"o9:','"o:','3:','@:','@~:','E:','E~:','O9~:','O:','O~:','U:','a+:','a9:','a9~:','a:','a_):','a_:','a_~:',
...
features['no modifier'] = new Set(['"@','"@)','"@)S','"@:','"@S','"e','"e:','"eS','"e_','"he','"ho','"o','"o(','"o(:',
...
features['fricative'] = new Set(['iF','uF','uuF']);
features['retroflexed'] = new Set(['"@.','a.','i .']);
features['pharyngealized'] = new Set(['"e9','"o/9','"o9','"o9:','"o9~','49','I9','O9','O9~:','U9','a9','a9:','a9~','a9~:','aa9','ae9','ae9~','ao9','ao9~','i9','i9:','oa9',
...
features['laryngealized'] = new Set(['"d*','"l*','"n*','"r*','"rr*','"t*','"tlF*','"ts*','N*','RAW*','b*','d*','d.*','dD*','d_*','dj*','gA*','gF*','h*','j*','k*','kW*',
                                'l*','l.[*','m*','n*','nD*','nj*','p*','q*','qW*','rDT*','s*','sD*','t.*','tD*','tS*','ts*','w*','z.*','"e*','"e~*','"o*','"o~*','E*','O*','a*',
                                'a~*','e*','i*','i~*','o*','u*',]) //  for both v & c

features['nasalized'] = new Set(['"@~','"e~','"e~*','"o(+~','"o(~','"o9~','"o~','"o~*','3~','@)~','@~','@~:','E)~','EO~','E~','E~:','I_~','I~','O9~:','Oi~','O~','O~:',
                                'U~','^~','a+i~','a+~','a9~','a9~:','a_)~','a_O~','a_~','a_~:','aa~','ae9~','ai~','ao9~','a~','a~*','a~:','ei~','eu~','e~','e~:','i_i~',
                                'i_~','i_~:','ie~','i~','i~*','i~-','i~:','oa9~','oa~','oi9~','oi~','ou~','o~','o~:','ui~','uu~','u~','u~:','y~',]);

features['breathy voicing'] = new Set(['Eh','Oh','Oih','^h','a_)h','ah','aih','auh','auuh','eh','i@h','iEh','iah','ih','iuh','o(h','o(ih','oh','oih','u@h','uah','uh',
                                'uih','uu@h','uuh','uuih',]);
features["'normal' voicing"] = new Set(['"@','"@)','"@)S','"@.','"@:','"@S','"@~','"e','"e*','"e9','"e:','"eS','"e_','"e~','"e~*','"o','"o(','"o(+~','"o(:','"o(~','"o*','"o+',
...
features['voiceless'] = new Set(['"he','"ho','ha','hi','hu','!','!?','!h','!xh','"hl','"hlF','"hlF\'','"hlF:','"hlFJ','"hlFW','"hlFW:','"hn','"hr','"hrA','"hrr','"hs','"ns',
...
features['high'] = new Set(['3i','@i','@u','@uu','Ei','Euu','Oi','Oih','Oi~','Oy','a+i','a+i~','aai','aau+','ai','ai_','aih','ai~','au','auh','auu','auuh',
...
features['lowered high'] = new Set(['I','I9','IS','I_','I_~','Ie','I~','U','U+','U9','U:','US','UU','UUS','Ui','U~','Y',]);

features['higher mid'] = new Set(['@','@)','@)~','@:','@~','@~:','e','e*','e:','e_','eh','e~','e~:','o','o(','o(+','o(h','o(i','o(ih','o*','o+','o/',
                            'o/:','o/S','o/_','o/y','o:','oS','oh','oih','o~','o~:',]);
features['mid'] = new Set(['"@','"@)','"@)S','"@.','"@:','"@S','"@~','"e','"e*','"e9','"e:','"eS','"e_','"e~','"e~*','"he','"ho','"o','"o(','"o(+~','"o(:','"o(~',
                    ...
                    'uu@h','yo/',]);
features['lower mid'] = new Set(['3','3)','3:','3i','3~','E','E)','E)~','E*','E:','EO~','ES','Eh','Ei','Eo','Euu','E~','E~:','O','O*','O9','O9~:',
                            'O:','OS','Oh','Oi','Oih','Oi~','Oy','O~','O~:','^','^h','^~','aE','a_O~','iE','iEh','i^','u^','uu^',]);
features['raised low'] = new Set(['4','4)S','4)_','49','4S','4_','aa','aa9','aa:','aai','aau+','aa~',]);
features['low'] = new Set(['a','a*','a+','a+:','a+i','a+i~','a+~','a.','a9','a9:','a9~','a9~:','a:','aE','aS','a_','a_)','a_):','a_)S','a_)h','a_)~','a_:',
                    'a_O~','a_~','a_~:','ae','ae9','ae9~','ah','ai','ai_','aih','ai~','ao','ao9','ao9~','au','auh','auu','auuh','a~','a~*','a~:','ea','ha',
                    'i_a','ia','ia+','iah','oa','oa9','oa9~','oa~','ua','uah','uua',]);

features['front'] = new Set(['"e','"e*','"e9','"e:','"eS','"e~','"e~*','"he','"o/','"o/9','"o/:','3i','@i','E','E)','E)~','E*','E:','EO~','ES','Eh','Ei',
...
features['retracted front'] = new Set(['"e_','e_','o/_',]);
features['central'] = new Set(['"@','"@)','"@)S','"@.','"@:','"@S','"@~','3','3)','3:','3i','3~','4','4)S','49','4S','@','@)','@)~','@:','@i','@u',
...
features['fronted back'] = new Set(['"o(+~','"o+','o(+','o+',]);
features['back'] = new Set(['"ho','"o','"o(','"o(:','"o(~','"o*','"o9','"o9:','"o9~','"o:','"oS','"o~','"o~*','4)_','4_','@u','@uu','EO~','Eo','Euu','O','O*',
...
features['unrounded'] = new Set(['"@','"@.','"@:','"@S','"@~','"e','"e*','"e9','"e:','"eS','"e_','"e~','"e~*','"he','"o(','"o(+~','"o(:','"o(~','3','3:','3i','3~',
...
features['rounded'] = new Set(['"@)','"@)S','"ho','"o','"o*','"o+','"o/','"o/9','"o/:','"o9','"o9:','"o9~','"o:','"oS','"o~','"o~*','3)','4)S','4)_','@)','@)~',
...
features['Monopthong'] = new Set(['"@','"@)','"@)S','"@.','"@:','"@S','"@~','"e','"e*','"e9','"e:','"eS','"e_','"e~','"e~*','"he','"ho','"o','"o(','"o(+~','"o(:','"o(~',
...
features['Diphthong'] = new Set(['3i','@i','@u','@uu','EO~','Ei','Eo','Euu','Ie','Oi','Oih','Oi~','Oy','Ui','a+i','a+i~','aE','a_O~','aai','aau+','ae','ae9',
...
features['voiced'] = new Set(['"6','"d','"d*','"d9','"d<','"dJ','"dW','"dh','"dlF','"dz','"dzJ','"dzh','"l','"l*','"l-','"l9','"lF','"lJ','"l[','"lh','"n','"n*',
...
features['no aspiration, etc.'] = new Set(['!','!?','"6','"d','"d*','"d9','"d<','"dJ','"dW','"dlF','"dz','"dzJ','"hl','"hlF','"hlF\'','"hlF:','"hlFJ','"hlFW','"hlFW:','"hn','"hr','"hrA',
                                    ...
                                    'z.*','zD','zD9','zDJ','|','|?','|x',]);
features['aspirated'] = new Set(['!h','!xh','"sh','"t-h','"tJh','"tWh','"th','"tlFWh','"tlFh','"tsWh','"tsh','#h','#jh','#xh','/=h','/h','/xh','Nkh','Nqh','cC,h','cCh','ch',
...
features['preaspirated'] = new Set(['"hs','hS','hk','hp','ht','htS',]);
features['prestopped'] = new Set(['dlD']);
features['prenasalized'] = new Set(['"nd','"ndJ','"ndW','"ns','"nt','"nts','"nz','Ng','NgW','Nk','NkJ','NkW','Nkh','Nmgb','Nq','Nqh','mb','mbJ','mbW','mp','mph','mv',
                            'nZ','nc','ncC,','nd','nd.','nd.z','ndD','ndDz','ndJ','ndZ','nd_','ndj','ndjjF','ndjz,','ndz','nr','nt','nt.','nt.s','nt.sh','ntD',
                            'ntDh','ntDs','ntDsh','ntS','ntSh','nt_','nz','nzD',]);
features['breathy'] = new Set(['"dh','"dzh','"lh','"nh','"thh','"tshh','Nh','Zh','bJh','bh','d.h','dDh','dZh','dzh','g#jh','g/=h','g/h','gWh','gh','g|h','khh','l_h',
                        'mh','n#jh','n/=h','n/h','nDh','n_h','n|h','phh','tDhh','thh','tshh','vh',]);

features['no sec. articulation'] = new Set(['!','!?','!h','!xh','"6','"d','"d<','"dh','"dlF','"dz','"dzh','"hl','"hlF','"hlF\'','"hlF:','"hn','"hr','"hrA','"hrr','"hs','"l','"lF',
...
features['labialized'] = new Set(['"dW','"hlFW','"hlFW:','"nW','"ndW','"sW','"sW:','"tW','"tWh','"tlFW\'','"tlFWh','"tsW\'','"tsW:','"tsWh','"zW','?W','CW','GW','GW9','NW','NgW','NkW',
...
features['palatalized'] = new Set(['"dJ','"dzJ','"hlFJ','"lJ','"nJ','"ndJ','"rJ','"r[J','"sJ','"tJ','"tJh','"tsJ','"zJ','6DJ','BAJ','BJ','NJ','NkJ','PJ','SJ','ZJ','bJ',
...
features['velarized'] = new Set(['"l-','"r-','"t-h','BA-','PW-','S-','Z-','bW-','d-','dZ-','dz-','hl-','hn-','hn/x?','hr[-','l-','lD-','mW-','n-','pW-h','r[-','t-',
                            'tS-','ts-','|xh',]);

features['bilabial'] = new Set(['B','BA','BA-','BA:','BAJ','BJ','P','P\'','PA','PJ','PW','PW-','b','b\'','b*','b:','b<','bJ','bJ<','bJh','bW','bW-',
                        'bh','bm','hm','hp','m','m*','m:','mJ','mW','mW-','mb','mbJ','mbW','mh','mp','mph','p','p\'','p*','p:','p<','pJ','pJh',
                        'pW','pW-h','ph','phh',]);
features['labiodental'] = new Set(['bD','bv','f','f\'','f:','fJ','fW','mD','mv','pf','pf\'','pfh','v','vA','vJ','vW','v[','vh',]);
features['dental'] = new Set(['0D','6D','6DJ','dD','dD*','dD6','dD9','dD<','dDJ','dDh','dDn','dDz','dlD','g|','g|h','g|x','g|x?','hlD','hlDF','hlDF:','hlDFJ','hlDFJ\'',
                        ...
                        'zD','zD9','zDJ','|','|?','|h','|x','|xh',]);
features['dental/alveolar'] = new Set(['"6','"d','"d*','"d9','"d<','"dJ','"dW','"dh','"dlF','"dz','"dzJ','"dzh','"hl','"hlF','"hlF\'','"hlF:','"hlFJ','"hlFW','"hlFW:','"hn','"hr','"hrA',
...
features['alveolar'] = new Set(['#','#?','#h','#xh','/','/h','/s','/x','/xh','6','d','d\'','d*','d-','d<','dJ','dlF','dn','dz','dz\'','dz-','dzh',
...
features['palato-alveolar'] = new Set(['!','!?','!h','!xh','0_','6_','S','S\'','S-','S:','SJ','SW','SW:','Z','Z-','ZJ','ZW','Zh','dZ','dZ\'','dZ-','dZJ',
...
features['retroflex'] = new Set(['0','6','d.','d.*','d.<','d.h','d.n','d.r','d.z','hl.','hn.','l.','l.F','l.[','l.[*','n.','nd.','nd.z','nt.','nt.s','nt.sh',
                            'r.','r.A','r.[','r.[~','s.','s.\'','t.','t.*','t.0','t.h','t.r','t.s','t.s\'','t.sh','z.','z.*',]);
features['palatal'] = new Set(['#j','#jh','#jx','/=','/=h','/=x','C','C,','C,\'','CW','c','c\'','c:','cC','cC,','cC,\'','cC,h','cCW','cCh','ch','dj','dj*',
...
features['labial-palatal'] = new Set(['wj']);
features['velar'] = new Set(['L','N','N*','N9','NJ','NW','Ng','NgW','Nh','Nk','NkJ','NkW','Nkh','g','g\'','g<','gA','gA*','gF','gF*','gFJ','gFW',
...
features['velar-alveolar'] = new Set(['hxlF']);
features['labial-velar'] = new Set(['Nm','Nmgb','gb','gbW','hNm','hw','kp','kpW','kph','w','w*','w~',]);
features['uvular'] = new Set(['G','G9','GW','GW9','Nq','Nqh','R','RA','RAW','RAW*','RF','RF9','RFW','RFW9','X','X\'','X9','X9:','X:','XW','XW\'','XW9',
                        'XW9:','XW:','nU','q','q\'','q*','q9\'','q9h','q:','q<','qW','qW\'','qW*','qW9\'','qW9h','qW:','qWh','qX','qX\'','qX\':','qX9',
                        'qX9\'','qX9\':','qX:','qXW','qXW\'','qXW9','qXW9\'','qh',]);
features['pharyngeal'] = new Set(['9','99','H']);
features['glottal'] = new Set(['?','?9','??','?W','h','h*','hJ','hW','hh',]);

features['sibilant'] = new Set(['"dz','"dzJ','"dzh','"hs','"ns','"nts','"nz','"s','"s\'','"s9','"s:','"sJ','"sW','"sW:','"sh','"ts','"ts\'','"ts\':','"ts*','"ts:','"tsJ',
...
features['lateral'] = new Set(['"dlF','"hl','"hlF','"hlF\'','"hlF:','"hlFJ','"hlFW','"hlFW:','"l','"l*','"l-','"l9','"lF','"lJ','"l[','"lh','"tlF','"tlF\'','"tlF\':','"tlF*','"tlF:',
...
features['click'] = new Set(['!','!?','!h','!xh','/','/=','/=h','/=x','/h','/x','/xh','g!','g/','g/=','g/=h','g/=x','g/=x?','g/h','g/x','g/x?',
                        'hn!?','hn!h','hn/=?','hn/=h','hn/=x?','hn/?','hn/h','hn/x?','n!','n/','n/=','n/=h','n/h',]);
features['affricated click'] = new Set(['#','#?','#h','#j','#jh','#jx','#xh','/s','g#','g#j','g#jh','g#jx','g#jx?','g|','g|h','g|x','g|x?','hn#?','hn#h','hn#j?','hn#jh',
                                'hn#jx?','hn|?','hn|h','hn|x?','n#','n#j','n#jh','n|','n|h','|','|?','|h','|x',]);
features['velar-fricated click'] = new Set(['!xh','#jx','#xh','/=x','/x','/xh','g#jx','g#jx?','g/=x','g/=x?','g/x','g/x?','g|x','g|x?','hn#jx?','hn/=x?','hn|x?','|x',]);
features['ejective stop'] = new Set(['"t\'','b\'','c\'','d\'','g\'','k\'','kJ\'','kW\'','p\'','q\'','q9\'','qW\'','qW9\'','t\'','tD\'',]);
features['ejective fricative'] = new Set(['"hlF\'','"s\'','C,\'','P\'','S\'','X\'','XW\'','f\'','hlDFJ\'','s\'','s.\'','sD\'','x\'','xW\'',]);
features['ejective affricate'] = new Set(['"tlF\'','"tlF\':','"tlFW\'','"ts\'','"ts\':','"tsW\'','cC,\'','dZ\'','dz\'','klF\'','kx\':','pf\'','qX\'','qX\':','qX9\'','qX9\':','qXW\'',
                                    'qXW9\'','t.s\'','tD0\'','tDs\'','tS\'','tS\':','tSW\'','tlF\'','ts\'',]);
features['implosive'] = new Set(['"d<','b<','bJ<','d.<','d<','dD<','d_<','dj<','g<','p<','q<','t<',]);
features['plosive'] = new Set(['"d','"d*','"d9','"dJ','"dW','"dh','"nd','"ndJ','"ndW','"nt','"t','"t*','"t-h','"t9','"t:','"tJ','"tJh','"tW','"tWh','"th','"thh','99',
...
features['r-sound'] = new Set(['"hrr','"rr','"rr*','rr','rrD','rrJ',]);
features['approximant'] = new Set(['"hl','"hrA','"l','"l*','"l-','"l9','"lJ','"lh','"rA','BA','BA-','BA:','BAJ','L','PA','RA','RAW','RAW*','dlD','gA','gA*',
                            'hj','hl','hl-','hl.','hlD','hlJ','hw','j','j*','j_','j~','l','l*','l-','l.','l9','lD','lD-','lD:','lDJ','lJ','l_','l_h','lj','l~',
                            'r.A','rA','vA','w','w*','wj','w~',]);

features['no release modifier'] = new Set(['!','!?','!h','!xh','"6','"d','"d*','"d9','"d<','"dJ','"dW','"dh','"dlF','"dz','"dzJ','"dzh','"hl','"hlF','"hlF\'','"hlF:','"hlFJ','"hlFW',
